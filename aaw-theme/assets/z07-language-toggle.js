(function () {
  ...
  const rows = [
    ...
    ["Those who listen will find the way.", "善听者，终得其道。", "善聽者，終得其道。", "よく聴く者こそ、道を見つける。", "제대로 듣는 자가 길을 찾는다."],
    ["Price", "价格", "價格", "価格", "가격"],
    ...
    ["Email: sales@acousticwerkes.com", "邮箱：sales@acousticwerkes.com", "信箱：sales@acousticwerkes.com", "メール：sales@acousticwerkes.com", "이메일: sales@acousticwerkes.com"],
    ...
    ["In Singapore, you can start with AAW Office, Zeppelin & Co., JABEN, or AV One. For demo, support, warranty, or dealer questions, contact AAW Singapore at sales@acousticwerkes.com or +65-8731-5476.", "在新加坡，您可以从 AAW Office、Zeppelin & Co.、JABEN 或 AV One 开始试听。如需试听、支持、保修或经销商咨询，请联系 AAW Singapore：sales@acousticwerkes.com 或 +65-8731-5476。", "在新加坡，您可以從 AAW Office、Zeppelin & Co.、JABEN 或 AV One 開始試聽。如需試聽、支援、保固或經銷商諮詢，請聯絡 AAW Singapore：sales@acousticwerkes.com 或 +65-8731-5476。", "シンガポールでは、AAW Office、Zeppelin & Co.、JABEN、AV One からお試しいただけます。試聴、サポート、保証、販売店に関するお問い合わせは、AAW Singapore（sales@acousticwerkes.com / +65-8731-5476）までご連絡ください。", "싱가포르에서는 AAW Office, Zeppelin & Co., JABEN, AV One에서 청음을 시작할 수 있습니다. 청음, 지원, 보증, 딜러 문의는 AAW Singapore(sales@acousticwerkes.com / +65-8731-5476)로 연락하세요."],
